...
public class Patient {
	...
	public Patient(int pid, @NotBlank(message = "Student Name cannot be blank") String pfname, String plname,
			@NotNull(message = "Student phone cannot be null") long pphone,
			@NotBlank(message = "Student Email cannot be blank") @Email(message = "Email is incorrect") String pemail,
			...
			EmergencyContactPerson emergencyContactPerson, com.anudip.Entity.HealthInsurance healthInsurance) {
		super();
		this.pid = pid;
		this.pfname = pfname;
		this.plname = plname;
