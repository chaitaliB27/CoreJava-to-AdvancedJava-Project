...
public class HealthInsurance {
	...
	@NotBlank(message = "HealthInsurance company Name cannot be blank")
	private String cName;
	
	@Column(length=25, nullable = false, unique = true)
	@NotNull(message = "HealthInsurance phone cannot be null")
	private long cphone;
	...
	public HealthInsurance(int hcid, @NotBlank(message = "HealthInsurance company Name cannot be blank") String cName,
			@NotNull(message = "HealthInsurance phone cannot be null") long cphone,
