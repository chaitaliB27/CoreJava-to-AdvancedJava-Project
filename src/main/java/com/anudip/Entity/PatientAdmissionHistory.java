...
public class PatientAdmissionHistory {
	...
	public PatientAdmissionHistory(int pahid, @NotBlank(message = "Student Name cannot be blank") @NotBlank(message = "Student Name cannot be blank") String ward_No,
			@NotBlank(message = "Student Name cannot be blank") int bed_No,
			@NotBlank(message = "Student Name cannot be blank") String admission_date,
			@NotBlank(message = "Student Name cannot be blank") String discharge_date,
			@NotBlank(message = "Student Name cannot be blank") int tatalCost) {
		super();
		this.pahid = pahid;
		this.ward_No = ward_No;
		this.bed_No = bed_No;
