...
public class EmergencyContactPerson {
	...
	public EmergencyContactPerson(int epid, @NotBlank(message = "Student Name cannot be blank") String epfname,
			String eplname, @NotNull(message = "Student phone cannot be null") long epphone, Patient patient) {
		super();
		this.epid = epid;
		this.epfname = epfname;
		this.eplname = eplname;
