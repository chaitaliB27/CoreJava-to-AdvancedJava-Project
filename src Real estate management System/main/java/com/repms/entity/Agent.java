...
public class Agent {
	...
	public Agent(int ait, @NotBlank(message = "Agent Name cannot be blank") String afname, String alname,
	...
	public String toString() {
		return "Agent [ait=" + ait + ", afname=" + afname + ", alname=" + alname + ", aphone=" + aphone + ", aemail="
				+ aemail + "]";
	}
