...
private int cit;
	...
	public String toString() {
		return "ClientDTO [cit=" + cit + ", cfname=" + cfname + ", clname=" + clname + ", cphone=" + cphone
				+ ", cemail=" + cemail + ", gender=" + gender + ", caddr=" + caddr + ", username=" + username
				+ ", password=" + password + "]";
	}

	
	public ClientDTO(int cit, @NotBlank(message = "Client Name cannot be blank") String cfname, String clname,
